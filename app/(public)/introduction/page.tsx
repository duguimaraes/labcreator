        ...
        <div className="mx-auto max-w-4xl">
          <div className="space-y-6 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground max-w-3xl">
              AI.CreatorLab is a digital workshop and portfolio platform designed for developers who
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded border border-border/50 bg-card/50 p-6 sm:p-10 backdrop-blur-sm space-y-8">
            ...
            <div className="space-y-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
              <p>
                AI.CreatorLab isn&apos;t just another portfolio website—it&apos;s a living, breathing
              ...
              <p>
                ...
                programming, or looking for modern web development patterns, AI.CreatorLab offers a window
