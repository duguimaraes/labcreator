...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/duguimaraes", handle: "@duguimaraes", icon: Github },
  { label: "Twitter", href: "https://twitter.com/ehsanghaffar", handle: "@duguimaraes", icon: Twitter },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/eduardo-ladeira-guimar%C3%A3es-a272a427b/", handle: "Eduardo L Guimarães", icon: Linkedin },
  { label: "Email", href: "mailto:hello@duguimaraes.dev", handle: "Eduardo L Guimarães", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            <div className="space-y-3">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">Quem sou eu</p>
            ...
            <div className="pt-2">
              <a
                href="mailto:eduardo@duguimaraes.dev"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} AI.CreatorLab — All experiments reserved
          </p>
        </div>
      </div>
    </footer>
